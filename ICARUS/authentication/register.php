  ...
  if($name!="" && $email!="" && $password!="" && $cpassword!=""){
    if($password===$cpassword){
      if(strlen($contact)==10){
        ...
        $sql_query="INSERT INTO `users` ( name, email, password, address, contact) VALUES ('$name','$email','$pwdencrypt','$address','$contact');";
          $result=mysqli_query($conn,$sql_query);
          if($result){
            header('location:login.php');
          }
          else{
            $message="Registration failed, contact support";
          }
      }
      else{
...
<div class="login-form">
  <form action="" method="post">
    ...
    <div class="input-field">
        <input type="text" placeholder="Full Name" autocomplete="nope" name="name">
      </div>
      <div class="input-field">
