...
if(isset($_POST['changepwd'])){
  ...
  if( $opassword!="" && $npassword!="" && $cpassword!="" ) {
    if($npassword===$cpassword) {
        ...
        if(password_verify($opassword,$row['PassWord'])==true) {
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="login.php">Subscribe and Save</a>
              </li>
  ...
  <form action="" method="post">
    ...
    <div class="content">
      <div class="input-field">
        <input type="password" placeholder="Enter Old Password" autocomplete="nope" name="opassword">
      </div>
      <div class="input-field">
