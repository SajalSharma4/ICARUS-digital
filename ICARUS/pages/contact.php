...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
      ...
      <div class="container-fluid about">
        <p class="fs-3 heading">For Any Problem, Please email us on the following : </p>
        <p class="fs-5 text"><em>ICARUS.ProductsHelp</em>@xyz.com </p>
        <p class="fs-5 text"><em>ICARUS.helpline</em>@abc.com </p>
        <br><br>
        <p class="fs-3 heading">You can also contact us on :</p>
        <p class="fs-5 text">9712****12</p>
        <p class="fs-5 text">9456****78</p>
      </div>
