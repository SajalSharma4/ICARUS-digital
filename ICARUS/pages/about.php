...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
      ...
      <div class="container-fluid about">
        <p class="fs-2 heading">Info About Website</p>
        <p class="fs-4 text"><em>ICARUS</em> is an e-commerce website centered around technological products. The website contains various new electonics which are good in quality and high in demand.</p>
        <br><br>
        <p class="fs-2 heading">Created by :</p>
        <p class="fs-4 text">Sajal Sharma</p>
        <p class="fs-4 text">sharma_sajal@xyz.com</p>
      </div>
